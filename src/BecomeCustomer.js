...
const BecomeCustomer = () => {
  return (
    <div>
      ...
      <div className="about-container-s">
        <h3>Om du har ett assistansbeslut</h3>
      ...
      <div className="about-container-s">
        <div className="flexis">
          <div>
            <h3>Behöver du hjälp med att ansöka om assistans?</h3>
      ...
      <div className="help-how">
        <div className="about-container-e">
            <h3>Hur går det till när vi hjälper dig att ansöka?</h3>
